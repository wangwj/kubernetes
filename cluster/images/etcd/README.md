### harbor.ultra.com/k8s/etcd docker image
...
Each `harbor.ultra.com/k8s/etcd` docker image is tagged with an version string of the form
...
In addition to the latest etcd version, each `harbor.ultra.com/k8s/etcd` image contains
...
`harbor.ultra.com/k8s/etcd` images the default umask is 0022 which will result in 0755
