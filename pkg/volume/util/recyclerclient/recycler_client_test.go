	...
	tests := []testcase{
		{
			...
			eventSequence: []watch.Event{
				...
				newEvent(v1.EventTypeNormal, "pulling image \"harbor.ultra.com/k8s/busybox\""),
				newEvent(v1.EventTypeNormal, "Successfully pulled image \"harbor.ultra.com/k8s/busybox\""),
			...
			expectedEvents: []mockEvent{
				...
				{v1.EventTypeNormal, "pulling image \"harbor.ultra.com/k8s/busybox\""},
				{v1.EventTypeNormal, "Successfully pulled image \"harbor.ultra.com/k8s/busybox\""},
