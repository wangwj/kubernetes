...
kube::build::get_docker_wrapped_binaries() {
  ...
  local targets=(
    cloud-controller-manager,"harbor.ultra.com/k8s/debian-base-${arch}:${debian_base_version}"
    kube-apiserver,"harbor.ultra.com/k8s/debian-base-${arch}:${debian_base_version}"
    kube-controller-manager,"harbor.ultra.com/k8s/debian-base-${arch}:${debian_base_version}"
    kube-scheduler,"harbor.ultra.com/k8s/debian-base-${arch}:${debian_base_version}"
    kube-proxy,"harbor.ultra.com/k8s/debian-iptables-${arch}:${debian_iptables_version}"
  )
